...
Subject to these Terms of Service (this "Agreement"), [internal-short.shopmy.com.au](/) ("Dub", "we", "us" and/or "our") provides access to Dub's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
Dub provides an open-source link management tool for modern marketing teams to create, share, and track short links ("the Product"). The Product is accessible at internal-short.shopmy.com.au and other domains and subdomains controlled by Us (collectively, "the Website").
...
If you're using a default internal-short.shopmy.com.au link, we reserve the right to reclaim the shortlink if needed, particularly if it is necessary for brand compliance, to prevent confusion among users, or to maintain the integrity and reputation of our Service.
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at support@internal-short.shopmy.com.au.
