...
We've also added a "Delete Account" feature to the [settings page](https://app.internal-short.shopmy.com.au/settings). You can now delete your Dub account and all associated data, if that's what you want to do.
